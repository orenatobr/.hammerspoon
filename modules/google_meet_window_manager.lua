...
--          whenever a new meeting window is created or an old one is focused.
...
--- Closes every other standard window belonging to win's app, then focuses win.
    ...
    for _, app in ipairs(hs.application.runningApplications()) do
        if appMatchesTarget(app) then
            ...
            if #standardWindows > 1 then
                ...
                if not keep or not keep:isStandard() then
